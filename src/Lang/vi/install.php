...
return [
    'info' => [
        'about' => 'SCart là một dự án website thương mại điện tử miễn phí cho doanh nghiệp, được xây dựng trên nền tảng Laravel framework (PHP & Mysql).',
        'about_pro' => 'Mã nguồn website thương mại điện tử doành cho doanh nghiệp!',
        'about_us' => '- Để hiểu thêm về chúng tôi, hãy ghé thăm <a target="_new" href="">Trang chủ của SCart</a>',
        'document' => '- Tài liệu hướng dẫn cài đặt <a target="_new" href="">TẠI ĐÂY</a>',
        'version' => 'Phiên bản',
        'terms' => '<span style="color:red">*</span> Vui lòng đọc điều kiện trước khi cài đặt <a target="_new" href="">Ở ĐÂY</a>.',
        'terms_pro' => '<span style="color:red">*</span> Vui lòng đọc điều kiện trước khi cài đặt <a target="_new" href="">Ở ĐÂY</a>.',
    ],
    'env' => [
    ...
    'installing_button' => 'Đang cài đặt SCart',
