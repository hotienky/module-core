...
return [
    'info' => [
        'about' => 'SCart is a free e-commerce website project for businesses, built on the Laravel framework (PHP & Mysql)',
        'about_pro' => 'Best Laravel eCommerce Platform for Business!',
        'about_us' => '- About us, please visit <a target="_new" href="">SCart\'s homepage</a>',
        'document' => '- Installation guide <a target="_new" href="">HERE</a>',
        'version' => 'Versions',
        'terms' => '<span style="color:red">*</span> Please read the terms before installing <a target="_new" href="">HERE</a>.',
        'terms_pro' => '<span style="color:red">*</span> Please read the terms before installing <a target="_new" href="">HERE</a>.',
        '',
    ],
    'env' => [
    ...
    'database' => [
        ...
        'process_1' => 'Initializing table database admin',
        'process_2' => 'Initializing table database shop',
        'process_3' => 'Initializing insert database admin',
        'process_4' => 'Initializing insert database shop',
        ...
        'process_sucess_3' => 'Insert data demo admin success!',
        'process_sucess_4' => 'Insert data demo shop success!',
        'process_sucess_5' => 'Insert data product, category success!',
        ...
        'error_3' => 'Error while insert data admin demo',
        'error_4' => 'Error while insert data shop demo',
        'error_5' => 'Error while insert data product, category',
    ],
    'permission' => [
    ...
    'installing_button' => 'Installing SCart',
